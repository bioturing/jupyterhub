...
const routes: AppRouteConfig[] = [
  ...
  },
  {
    component: NewServer,
    exact: true,
    label: 'Create New Notebook Server',
    path: normalizeRoute("/new-notebook"),
    title: normalizeTitle("Create notebook server"),
    hideFromNav: true
  },
	{
    component: Spawning,
    ...
    isAsync: true,
    label: '404 Not Found',
    path: normalizeRoute("/404"),
    title: normalizeTitle("404 Not found"),
		hideFromNav: true
  },
];
...
export { AppRoutes, routes , normalizeRoute};
